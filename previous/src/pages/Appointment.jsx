...
const Appointment = () => {
  ...
  const jsonLd = {
    ...
    description:
      'Schedule a free or premium visa consultation with A Visa Experts. Choose your preferred time and get expert guidance.',
    url: 'https://avisaexperts.com/appointment',
  };

  return (
    <LandingLayout>
      <SEO
        title="Book a Visa Consultation | A Visa Experts"
        description="Schedule a free visa consultation with A Visa Experts. Get personalized guidance from immigration experts for tourist, work, and transit visas."
        keywords="book visa consultation, visa appointment, immigration consultation, free visa advice, Kaveesh Kapoor"
        canonicalPath="/appointment"
        ogImage="/images/user/25-off-offer.png"
        jsonLd={jsonLd}
      />
