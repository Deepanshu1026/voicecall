        ...
        <div class="table-card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <div class="form-check form-switch d-flex align-items-center gap-2 border rounded px-3 py-2 bg-light">
                    <input class="form-check-input m-0" type="checkbox" role="switch" id="myListToggle" checked onchange="fetchRequests()">
...
function fetchRequests(isPolling = false) {
    ...
    fetch(apiUrl('api/agent/requests', { status: 'follow_up', my_list: myList }))
