...
const CallModal = ({ call }) => {
  const { user } = useAuth();
  const { setShowCallModal, setActiveCall, webrtc, localStream } = useCall();
      ...
      <div className="w-full max-w-md mx-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 flex items-center justify-center gap-2">
            ...
            {webrtc.callState === 'connected' ? formatCallDuration(webrtc.callDuration) : 'Connecting...'}
          </p>
        </div>
