const TypingIndicator = ({ variant = 'default' }) => {
  const bubbleClass = variant === 'user' ? 'message-bubble-received-user' : 'message-bubble-received';
  return (
    <div className={`${bubbleClass} inline-flex items-center gap-1.5 py-2.5 px-3.5`}>
