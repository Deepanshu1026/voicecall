          ...
          <div className="footer-section footer-second-clm margin-footer">
            ...
            <div className="social-media-links">
              ...
              <a href="/home" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
                  <rect x="2" y="3.35791" width="26" height="26" rx="6" fill="#E4405F" />
                  <circle cx="15" cy="16.3579" r="6" fill="white" />
                  <circle cx="22" cy="9.35791" r="2" fill="white" />
                </svg>
              </a>
