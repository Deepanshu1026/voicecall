    ...
    try {
      ...
      if (_selectedImageFile != null) {
        var request = http.MultipartRequest(
            'POST', Uri.parse(AppConfig.editProfile));
        ...
        final url =
            Uri.parse(AppConfig.editProfile).replace(
          queryParameters: {
            'userid': _userId,
      ...
      child: Builder(builder: (context) {
        ...
        if (hasValidExistingPath) {
          ...
          if (_existingProfileImagePath!.startsWith('http://') ||
            ...
            if (_existingProfileImagePath!.startsWith('/')) {
              fullExistingImageUrl =
                  '$base${_existingProfileImagePath!.substring(1)}';
            } else {
              fullExistingImageUrl =
                  '$base/$_existingProfileImagePath';
            }
          }
        }
