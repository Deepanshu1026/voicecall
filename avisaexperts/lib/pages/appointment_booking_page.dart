...
class _AppointmentBookingScreenState extends State<AppointmentBookingScreen> {
  ...
  Future<void> _loadUserDataAndInitialFetch() async {
    ...
    final String? loadedUserId = userIdValue is String
        ? userIdValue
  ...
  Future<void> _fetchMeetingModes() async {
    try {
      final response = await http.get(
        Uri.parse(AppConfig.meetingsStatus),
      );
  ...
  Future<void> _fetchTimeSlots() async {
    ...
    final url = Uri.parse(AppConfig.timeSlots)
  ...
  Future<void> _fetchUnavailableDates() async {
    ...
    final url = Uri.parse(AppConfig.cancelledDates);
  ...
  Future<void> _submitAppointment() async {
    ...
    final url = Uri.parse(AppConfig.appointments);
  ...
  Future<String?> _fetchOfferImage() async {
    try {
          final response = await http
          .get(
            Uri.parse(AppConfig.offerImage),
          )
