...
void main() async {
  ...
  try {
    ...
    // ✅ Start wallet polling and listen to real-time wallet updates.
    WalletService.bindSocketEvents();
    WalletService.startPolling();
    debugPrint('✅ WalletService started');
...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    // Bind global WebRTC call listeners and navigate to call screen when needed.
  ...
  void dispose() {
    ...
    _callService.unbindGlobalListeners();
