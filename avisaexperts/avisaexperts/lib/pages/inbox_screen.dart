...
class _InboxScreenState extends State<InboxScreen>
  ...
  List<Widget> _buildOrbitingAvatars(double animationValue) {
    final avatarUrls = [
      'https://avisaexperts.com/img/deepanshi%201.webp',
      'https://avisaexperts.com/img/sandhya.webp',
      'https://avisaexperts.com/img/khusi.webp',
      'https://avisaexperts.com/img/sadhika.webp',
    ];
