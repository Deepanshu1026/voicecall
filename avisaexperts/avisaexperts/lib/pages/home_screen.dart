...
class _HomeScreenState extends State<HomeScreen>
  ...
  Future<void> _fetchConsultants() async {
    ...
    const String baseUrl = "https://avisaexperts.com/";

    try {
      final response = await http
          .get(Uri.parse('https://avisaexperts.com/getAppAllConsultant.php'));
      if (!mounted) return;
  ...
  Future<void> _fetchBanners() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          'https://avisaexperts.com/digital_dashboard/get_banners.php'));
      if (!mounted) return;
  ...
  Future<void> _fetchSuccessStories() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'https://avisaexperts.com/review_API.php'), // Replace with actual endpoint
      );
              ...
              if (jsonItem is Map<String, dynamic>) {
                return SuccessStory(
                  ...
                  userImageUrl: jsonItem['user_image'] ??
                      'https://avisaexperts.com/img/default_user.webp',
                );
              } else {
                logger.w(
