  ...
  factory AppointmentTicket.fromJson(Map<String, dynamic> json) {
    ...
    if (json['screenshot'] != null &&
      ...
      if (rawUrl.startsWith('http://') || rawUrl.startsWith('https://')) {
        ...
        screenshotUrl = 'https://avisaexperts.com/$rawUrl';
      }
    }
...
class MyTicketsScreenState extends State<MyTicketsScreen> {
  ...
  Future<void> _loadUserIdAndFetchTickets() async {
    ...
    try {
      ...
      final storedUserId = prefs.getInt(USER_ID_PREFS_KEY);
...
class _TicketCardState extends State<_TicketCard> {
  ...
  Future<void> _uploadPaymentScreenshot() async {
    try {
      ...
      final uri = Uri.parse('https://avisaexperts.com/screenshot_update.php');
        ...
        try {
          ...
          if (decoded is Map<String, dynamic>) {
            if (decoded['status'] == 'success') {
              ...
              screenshotUrl =
                  'https://avisaexperts.com/uploads1/payment_screenshot/$fileName';
